      ...
      <div className="cd-row-1">
        <div>
          <div className="ji-line-1">
            ...
            <p className="ji-type">Fulltime</p>
          </div>

          <p className="cd-title">Senior Software Engineer</p>

          <p className="cd-location">London</p>
        </div>
        <button className="cd-apply-btn">Apply Now</button>
      </div>
      <div
        className="cd-desc"
        dangerouslySetInnerHTML={{ __html: filterDesc(data.description) }}
      ></div>
    </div>
  );
}
